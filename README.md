...
Full diagnosis and resolution steps are in [`docs/TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md).
...
| [`docs/TROUBLESHOOTING.md`](docs/TROUBLESHOOTING.md) | Diagnosis and resolution for known issues |
